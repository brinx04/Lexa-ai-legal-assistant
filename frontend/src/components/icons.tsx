...
// Hand-rolled 1.5px-stroke icon set — consistent geometry, no icon library.
...
export function ScaleIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3v18M5 21h14M12 6l-6 2 6-2 6 2-6-2z" />
      <path d="M6 8l-3 6a3.5 3.5 0 0 0 6 0l-3-6zM18 8l-3 6a3.5 3.5 0 0 0 6 0l-3-6z" />
    </svg>
  );
}
...
export function SparkIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M19 16l.7 2.1L21.8 19l-2.1.9L19 22l-.9-2.1L16 19l2.1-.9L19 16z" />
    </svg>
  );
}
...
export function ChatIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M21 12c0 4-4 7-9 7-1.5 0-3-.3-4.2-.8L3 20l1.4-3.5C3.5 15.2 3 13.7 3 12c0-4 4-7 9-7s9 3 9 7z" />
    </svg>
  );
}
